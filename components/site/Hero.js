...
export default function Hero() {
  ...
  const countProjects = useCountUp(400, 1500, true);
  const countExperience = useCountUp(5, 1000, true);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hero-left-col" style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
          {/* Badge Pill */}
          ...
          <div className="hero-heading-block" style={{ display: "flex", flexDirection: "column", gap: "16px", position: "relative" }}>
            <h1
          ...
          >
            <button onClick={() => scrollToSection("work")} className="btn-secondary" style={{ transition: "all 0.3s ease" }}>
              View Portfolio
              <ArrowUpRight size={18} />
            </button>
            <a href="/tools" className="btn-primary" style={{ transition: "all 0.3s ease", textDecoration: "none", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
              Free Tools
            </a>
          </div>
        ...
        >
          ...
          <div className="hero-photo-stage">
            ...
            <div className="hero-service-cards-grid">
            {/* Card 1: Logo Design */}
            <div 
